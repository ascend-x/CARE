...
class ProcessingSessions extends Table
  ...
  late final GeneratedColumn<String> patient = GeneratedColumn<String>(
      'patient', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  late final GeneratedColumn<String> encounter = GeneratedColumn<String>(
      'encounter', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  late final GeneratedColumn<bool> isDocumentAttached = GeneratedColumn<bool>(
      'is_document_attached', aliasedName, true,
  ...
  ProcessingSessionsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProcessingSessionsData(
      ...
      patient: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}patient']),
      encounter: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}encounter']),
      isDocumentAttached: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}is_document_attached']),
    );
  }
...
class ProcessingSessionsData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || patient != null) {
      map['patient'] = Variable<String>(patient);
    }
    if (!nullToAbsent || encounter != null) {
      map['encounter'] = Variable<String>(encounter);
    }
    if (!nullToAbsent || isDocumentAttached != null) {
      map['is_document_attached'] = Variable<bool>(isDocumentAttached);
    }
    return map;
  }
  ...
  ProcessingSessionsCompanion toCompanion(bool nullToAbsent) {
    return ProcessingSessionsCompanion(
      ...
      encounter: encounter == null && nullToAbsent
          ? const Value.absent()
          : Value(encounter),
      isDocumentAttached: isDocumentAttached == null && nullToAbsent
          ? const Value.absent()
  ...
  factory ProcessingSessionsData.fromJson(Map<String, dynamic> json,
    ...
    return ProcessingSessionsData(
      ...
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      patient: serializer.fromJson<String?>(json['patient']),
      encounter: serializer.fromJson<String?>(json['encounter']),
      isDocumentAttached:
          serializer.fromJson<bool?>(json['isDocumentAttached']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'patient': serializer.toJson<String?>(patient),
      'encounter': serializer.toJson<String?>(encounter),
      'isDocumentAttached': serializer.toJson<bool?>(isDocumentAttached),
    };
  }
  ...
  ProcessingSessionsData copyWith(
          ...
          DateTime? createdAt,
          Value<String?> patient = const Value.absent(),
          Value<String?> encounter = const Value.absent(),
          Value<bool?> isDocumentAttached = const Value.absent()}) =>
      ProcessingSessionsData(
        ...
        encounter: encounter.present ? encounter.value : this.encounter,
        isDocumentAttached: isDocumentAttached.present
            ? isDocumentAttached.value
            : this.isDocumentAttached,
      );
  ProcessingSessionsData copyWithCompanion(ProcessingSessionsCompanion data) {
    return ProcessingSessionsData(
      ...
      encounter: data.encounter.present ? data.encounter.value : this.encounter,
      isDocumentAttached: data.isDocumentAttached.present
          ? data.isDocumentAttached.value
          : this.isDocumentAttached,
    );
  }
  ...
  String toString() {
    return (StringBuffer('ProcessingSessionsData(')
          ...
          ..write('isDocumentAttached: $isDocumentAttached')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(id, filePaths, resources, status, origin,
      createdAt, patient, encounter, isDocumentAttached);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProcessingSessionsData &&
          ...
          other.isDocumentAttached == this.isDocumentAttached);
}
...
class ProcessingSessionsCompanion
  ...
  final Value<DateTime> createdAt;
  final Value<String?> patient;
  final Value<String?> encounter;
  final Value<bool?> isDocumentAttached;
  final Value<int> rowid;
  const ProcessingSessionsCompanion({
    ...
    this.isDocumentAttached = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<ProcessingSessionsData> custom({
    ...
    Expression<String>? encounter,
    Expression<bool>? isDocumentAttached,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  ProcessingSessionsCompanion copyWith(
      ...
      Value<String?>? encounter,
      Value<bool?>? isDocumentAttached,
      Value<int>? rowid}) {
    return ProcessingSessionsCompanion(
      id: id ?? this.id,
      ...
      isDocumentAttached: isDocumentAttached ?? this.isDocumentAttached,
      rowid: rowid ?? this.rowid,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (patient.present) {
      map['patient'] = Variable<String>(patient.value);
    }
    if (encounter.present) {
      map['encounter'] = Variable<String>(encounter.value);
    }
    if (isDocumentAttached.present) {
      map['is_document_attached'] = Variable<bool>(isDocumentAttached.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
